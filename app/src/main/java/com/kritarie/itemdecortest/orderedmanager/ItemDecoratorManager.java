...
import com.kritarie.itemdecortest.orderedmanager.log.DecoratorLog;
import com.kritarie.itemdecortest.orderedmanager.log.DefaultLog;
...
public final class ItemDecoratorManager extends RecyclerView.ItemDecoration {
    ...
    public static class Builder {
        ...
        public ItemDecoratorManager build() {
            if (mDecoratorLog == null) mDecoratorLog = new DefaultLog();
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        mDecoratorLog.logItemOffsetStart();
    ...
    public void onDraw(Canvas c, RecyclerView parent, RecyclerView.State state) {
        mDecoratorLog.logDrawOverStart();
